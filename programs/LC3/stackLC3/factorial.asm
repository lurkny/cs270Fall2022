...
Checkpoint1     LDR   R0, R5, #4   ; Load parameter N into a register
		 ...
		 ;____________________ ; Store N - 1 in the local variable
 		STR R2,R5,#0               
                ...
                ;;;; Start of the recursive call
             	...
             	PUSH R2   ;__________________ ; Step 1: push parameter N - 1
               	JSR Factorial ;__________________ ; Step 2: call Factorial(N - 1)
...
Main            LD    R6, Stack     ; Initialize stack pointer
		...
		ADD R6, R6,#1
                ...
                ;__________________ ; Step 14: remove parameter from stack
               	...
               	ST R1, Result ;__________________ ; Store return value in Result
